			...
			<div id="breadcrumb">
				...
				<div class="span12">		
						<div class="widget-box">
							...
							<h5>友情链接</h5>
							{{-- 搜索框开始 --}}
							<form action="/admin/friend" method="get" style="float: right;padding-top: 4px;">
								<label>Search: <input type="text" aria-controls="DataTables_Table_0" name="search" value="{{ $request['search'] or '' }}" ><button class="btn btn-info">搜索</button></label>
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table" >
									...
									<td style="padding-left:30px;padding-top:19px;">{{ $v->flk_status==0? '待审':'通过' }}</td>
