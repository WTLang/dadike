        ...
        <ul class="comment-list">
            <li class="comment">
                ...
                <div class="comment-body">
                    <div class="comment-author"><img src="/all_uploads/{{ $v->usds_head }}" alt="" class="img-circle" style="width:80px;height:80px"> </div>
                    <div class="comment-info">
                        ...
                        <a href="" class="btn btn-default">赞 &nbsp {{ $v->trd_good }}</a>
                        <a href="" class="btn btn-default">踩 &nbsp {{ $v->trd_bad }}</a>
